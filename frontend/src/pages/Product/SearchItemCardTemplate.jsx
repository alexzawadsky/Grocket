const SearchItemCardTemplate = ({ horizontal }) => {
    ...
    if (!horizontal) return (
        <div className="p-5 h-full">
            <div className="bg-slate-50/[.8] grid gap-1 rounded-xl">
                <div className='bg-slate-100 rounded-xl aspect-[4/3]'></div>
    ...
    return (
        <div className="p-5">
            <div className='grid grid-cols-[1fr_2fr] xl:grid-cols-[1fr_2fr_1fr] bg-slate-50/[.8] rounded-2xl overflow-hidden'>
                <div className='bg-slate-100 aspect-[4/3]'></div>
                <div className='p-4 grid grid-rows-6 gap-1'>
                    <p className=" bg-slate-100 w-44"></p>
                    <p className=" bg-slate-100 w-full"></p>
                    <p className=" bg-slate-100 w-52"></p>
                    <p className=" bg-slate-100 w-44"></p>
                    <p className=" bg-slate-100 w-44"></p>
                    <p className=" bg-slate-100 w-44"></p>
                </div>
