...
const LanguageSelectionBanner = () => {
    ...
    return (!languageSelected && i18n.resolvedLanguage !== code) ?
        <div className="flex gap-3 md:gap-6 items-center flex-wrap h-[51px] border-2 dark:border-zinc-600 rounded-2xl px-3 w-fit fixed max-md:left-2 bottom-2 md:right-[68px] z-50 bg-white dark:bg-zinc-800">
